...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        ClassicEditor.create(document.querySelector('#postContent'), {
            language: 'ko',
            ckfinder: {
                uploadUrl: '/MBProject/FileUpload?action=upload',
                options: {
                    resourceType: 'Images',
                    deleteUrl: '/MBProject/FileUpload?action=delete'
                }
            },
            height: 500
        })
    ...
    function deleteFile(filePath) {
        ...
        fetch('/MBProject/FileUpload?action=delete&filePath=' + encodeURIComponent(filePath), {
            method: 'POST',
            headers: {
    ...
    function submitPost() {
        ...
        formData.append('bid', document.getElementById('boardNum').value); // 서버가 요구하는 모든 필수 파라미터를 포함
        ...
        return fetch('/MBProject/updateBoard.do', {
            method: 'POST',
            body: formData
           });
       }
